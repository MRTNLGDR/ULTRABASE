...
const APPLICATION_NAME = 'Ultrabase Studio'
...
function buildRootHead() {
  ...
  const links: Array<Record<string, string>> = [
    ...
    { rel: 'shortcut icon', href: `${BASE_PATH}${FAVICON_ROUTE}/ultrabase.svg` },
    { rel: 'icon', type: 'image/svg+xml', href: `${BASE_PATH}${FAVICON_ROUTE}/ultrabase.svg` },
    { rel: 'apple-touch-icon', href: `${BASE_PATH}${FAVICON_ROUTE}/ultrabase.svg` },
